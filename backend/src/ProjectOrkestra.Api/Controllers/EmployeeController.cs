...
public class EmployeeController : ControllerBase
{
    ...
    public async Task<IActionResult> ListByBusinessUnit(
        [FromQuery] Guid businessUnitId,
        [FromQuery] IEnumerable<EmployeeStatus>? statuses
    )
    {
        IEnumerable<Employee?> employees = await _listEmployeesByBusinessUnitUseCase.ExecuteAsync(
            businessUnitId,
            statuses
        );
    ...
    {
        IEnumerable<Employee?> employees = await _listEmployeesByOrganizationUseCase.ExecuteAsync(
            organizationId,
            statuses
        );
