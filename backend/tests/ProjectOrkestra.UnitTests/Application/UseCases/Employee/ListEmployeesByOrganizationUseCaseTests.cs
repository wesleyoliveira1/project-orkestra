...
public class ListEmployeesByOrganizationUseCaseTests
{
    ...
    public async Task ExecuteAsync_WhenEmployeesExist_ReturnsListOfEmployees()
    {
        ...
        ListEmployeesByOrganizationUseCase useCase = new ListEmployeesByOrganizationUseCase(
            repository
        );
        ...
        repository
            .GetAllByOrganizationIdAsync(organizationId, Arg.Any<IEnumerable<EmployeeStatus>>())
            .Returns(employees);
    ...
    public async Task ExecuteAsync_WithCustomStatusFilter_ReturnsEmployeesWithFilteredStatuses()
    {
        ...
        repository
            .GetAllByOrganizationIdAsync(organizationId, statusFilter)
        ...
        Assert.All(
            ...
            emp => Assert.Equal(EmployeeStatus.FreeDay, emp.Status)
        );
    }
    ...
    public async Task ExecuteAsync_WithMultipleStatusFilters_ReturnsEmployeesMatchingAnyStatus()
    {
        ...
        repository.GetAllByOrganizationIdAsync(organizationId, statusFilter).Returns(employees);
